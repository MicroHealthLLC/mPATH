...
jQuery(function($) {
  ...
  $(".project_privileges_select, #q_facility_project_facility_id, #task_facility_project_attributes_project_id").select2({
    placeholder: "Search and select Project",
    allowClear: false
  });

  $(".program_select, #q_facility_project_project_id, #task_facility_project_attributes_facility_id").select2({
    placeholder: "Search and select Program",
    allowClear: false
  });
