<template>
  <div>
    <div class="d-flex mb-4">
      <div class="w-25 mr-1 d-inline-flex align-items-end">
      ...
      <div class="simple-select w-25 d-inline mr-1">
...
export default {
  ...
  data() {
    return {
      kanbanType: "tasks",
      currentTab: "tasks",
      currentFacility: Object.assign({}, this.facility),
      searchTasksQuery: "",
      searchIssuesQuery: "",
      searchRisksQuery: "",
      sidebarTasksQuery: "",
  ...
  methods: {
    ...
    handleAddNew(stage) {
      ...
      this.$router.push(
        `/programs/${this.$route.params.programId}/kanban/projects/${this.$route.params.projectId}/tasks/new`
      );
    },
