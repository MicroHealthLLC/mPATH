        ...
        <el-table-column prop="read" label="Read" width="75">
          <template slot-scope="scope">
            ...
            <span v-if="scope.$index !== 0">
              <span
                v-if="
                  scope.row.role_privileges.map((t) => t.role_type)[1] ==
                    project.tasks &&
                    scope.row.role_privileges
                      .map((t) => t.privilege)[1]
                      .includes('R')
        ...
        <el-table-column prop="read" label="Read" width="75">
          <template slot-scope="scope">
            ...
            <span v-if="scope.$index !== 0">
              <span
                v-if="
                  scope.row.role_privileges.map((t) => t.role_type)[2] ==
                    project.issues &&
                    scope.row.role_privileges
                      .map((t) => t.privilege)[2]
                      .includes('R')
        ...
        <el-table-column prop="read" label="Read" width="75">
          <template slot-scope="scope">
            ...
            <span v-if="scope.$index !== 0">
              <span
                v-if="
                  scope.row.role_privileges.map((t) => t.role_type)[3] ==
                    project.risks &&
                    scope.row.role_privileges
                      .map((t) => t.privilege)[3]
                      .includes('R')
        ...
        <el-table-column prop="read" label="Read" width="75">
          <template slot-scope="scope">
            ...
            <span v-if="scope.$index !== 0">
              <span
                v-if="
                  scope.row.role_privileges.map((t) => t.role_type)[4] ==
                    project.notes &&
                    scope.row.role_privileges
                      .map((t) => t.privilege)[4]
                      .includes('R')
        ...
        <el-table-column prop="read" label="Read" width="75">
          <template slot-scope="scope">
            ...
            <span v-if="scope.$index !== 0">
              <span
                v-if="
                  scope.row.role_privileges.map((t) => t.role_type)[5] ==
                    project.lessons &&
                    scope.row.role_privileges
                      .map((t) => t.privilege)[5]
                      .includes('R')
...
export default {
  ...
  methods: {
    ...
    analyticsRead() {
      ...
      if (
        this.isAnalyticsRead &&
        !this.analyticsPriv.map((t) => t).includes("R")
      ) {
    ...
    analyticsWrite() {
      ...
      if (
        this.isAnalyticsWrite &&
        !this.analyticsPriv.map((t) => t).includes("W")
      ) {
    ...
    analyticsDelete() {
      ...
      if (
        this.isAnalyticsDelete &&
        !this.analyticsPriv.map((t) => t).includes("D")
      ) {
    ...
    lessonsWrite() {
      ...
      if (
        this.isLessonsWrite &&
        !this.lessonsPriv.map((t) => t).includes("W")
      ) {
    ...
    lessonsDelete() {
      ...
      if (
        this.isLessonsDelete &&
        !this.lessonsPriv.map((t) => t).includes("D")
      ) {
