...
export default {
  ...
  methods: {
    ...
    hasPrivilege(row, privilegeType, privilege) {
      row.role_privileges.map((t) => t.role_type)[1] == privilegeType &&
        row.role_privileges.map((t) => t.privilege)[1].includes(privilege);
    },
