class User < ApplicationRecord
  ...
  devise :database_authenticatable,
         ...
         :validatable, :omniauthable, omniauth_providers: [:office365, :google_oauth2]
...
def update_sub_navigation_url(url, p, current_top_navigation_menu, sub_nav = nil)
  ...
  def admin?
    superadmin? || (privilege.present? && privilege.admin.present? && privilege.admin.to_s.include?("R"))
  end
