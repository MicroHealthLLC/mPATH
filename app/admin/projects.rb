    ...
    tabs do
      ...
      tab 'Advanced' do
        f.inputs 'Program Details' do
          ...
          # div id: 'task_stages_div', "data-data" =>  TaskStage.all.map{|u| {text: u.name, id: u.id} }.to_json, "data-selected-values" => f.object.task_stage_ids
          input :task_stages, label: 'Task Stages in Program', as: :select, collection: options_for_select( f.object.options_for_task_stage , f.object.task_stage_ids), multiple: true #, input_html: {class: "select2", "data-close-on-select" => false }
