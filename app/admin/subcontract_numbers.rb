ActiveAdmin.register SubcontractNumber do
  ...
  index do
    ...
    actions defaults: false do |cc|
      item "Edit", edit_admin_subcontract_number_path(cc), title: 'Edit', class: "member_link edit_link" if current_user.admin_write?
      item "Delete", admin_subcontract_number_path(cc), title: 'Delete', class: "member_link delete_link", 'data-confirm': 'Are you sure you want to delete this?', method: 'delete' if current_user.admin_delete?
    end
  end
