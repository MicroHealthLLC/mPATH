describe('Program Viewer ', function() {
  ...
  it('Open Task form and Save task', function() {
    ...
    cy.get('[data-cy="tab5"]').contains('Related').click()
    cy.get('[data-cy="tab6"]').contains('Updates').click()
  ...
  it('Open Risk form and Save Risk', function() {
    ...
    cy.get('[data-cy="tab6"]').contains('Related').click()
    cy.get('[data-cy="tab7"]').contains('Updates').click()
    cy.get('[data-cy="tab8"]').contains('Disposition').click()
  ...
  it('Open Lesson form and Save Lesson', function() {
    ...
    cy.get('[data-cy="tab2"]').contains('Related').click()
    cy.get('[data-cy="tab3"]').contains('Successes').click()
