...
Cypress.Commands.add("contractRollup", () => {
  cy.get('[data-cy=facility_rollup]').within(() => {
    ...
    cy.get('[data-cy="risks_count"]').should('contain', '2')
