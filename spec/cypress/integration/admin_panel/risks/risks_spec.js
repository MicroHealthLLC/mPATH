describe('Admin Panel Risk', function() {
  ...
  it('Search Task contains Facility', function() {
    cy.get('#q_facility_project_facility_facility_name').select('Test Facility 1')
